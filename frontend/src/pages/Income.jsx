...
const IncomeChart = ({ chartData, timeFrame, timeFrameRange }) => (
  ...
  <span className="text-sm text-slate-500 dark:text-slate-300 font-normal">
    ...
    <div className={styles.chartHeight}>
      {/* Use a fixed pixel height to avoid Recharts "width/height should be > 0" warnings when container is hidden or has 0 size */}
...
const Income = () => {
  ...
  const getAuthHeadersLocal = useCallback(() => {
    // kept for local usages inside this component but prefer central helper
